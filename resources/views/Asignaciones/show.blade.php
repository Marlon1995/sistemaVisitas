                    ...
                    <div class="col-lg-10 col-sm-10 col-md-10 col-xs-12">
                        <div class="form-group">
                            <h2 style="font-size: 25px;font-weight: bold; margin-left: -200px; text-align: center;">
                                ASIGNACION ENCARGADO PUERTA</h2>
                            ...
                            <div class="panel-body table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="postTable">
                                    ...
                                    @foreach($Asignados as $post)
                                        <tr class="item{{$post->idAsignacionEdificio}}">
                                            <td>{{$post->idAsignacionEdificio}}</td>
                                            <td>{{$post->Nombre}}</td>
                                            @if($Usuario->id!=1)

                                                <td>
                                                    <button class="delete-modal btn btn-danger"
                                                            data-id="{{$post->idAsignacionEdificio}}"
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if ((data.errors)) {
                        ...
                        $('#postTable').prepend("<tr class=item" + data.idAsignacionEdificio + ">" +
                            "<td>" + data.idAsignacionEdificio + "</td>" +
                            "<td>" + data.Nombre + "</td>" +
                            "<td>" +
                            "<button class='delete-modal btn btn-danger' data-id='" + data.idAsignacionEdificio + "' data-edificio='" + data.Nombre + "'><span class='glyphicon glyphicon-trash'></span></button> " +
                            "</td>" +
                            "</tr>");

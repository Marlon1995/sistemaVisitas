            ...
            <div class="panel panel-primary">
                <div class="panel-body">
                    ...
                    <div class="col-lg-10 col-sm-10 col-md-10 col-xs-12">
                        <div class="form-group">
                            <h2 style="font-size: 25px;font-weight: bold; margin-left: -200px; text-align: center;">CAMBIO DE CONTRASEÑA DE USUARIOS</h2>
                        </div>
                    </div>
                    ...
                    <form accept="{{url('cambiar')}}" method="post">
                        {{ csrf_field() }}
                        @if($Usuario->id == 1)
                            <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                <div class="form-group">
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                            <div class="form-group">
                                <br>
                                <button type="submit" class="btn btn-warning form-control"><span class="glyphicon glyphicon-edit"></span> Cambiar Contraseña</button>
                            </div>
                        </div>
                    </form>
                </div>
